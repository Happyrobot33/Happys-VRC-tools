...
public class CustomTransformInspector : Editor {
    ...
    public override void OnInspectorGUI(){
        ...
        if (GUILayout.Button("Copy", GUILayout.Width(50))) {
            ...
            string clipboard = "";
            clipboard += transform.localPosition.x + "," + transform.localPosition.y + "," + transform.localPosition.z + "\n";
        ...
        if (GUILayout.Button("Copy", GUILayout.Width(50))) {
            ...
            string clipboard = "";
            clipboard += transform.position.x + "," + transform.position.y + "," + transform.position.z + "\n";
        ...
        EditorGUILayout.LabelField("Experimental! May not work as expected!", EditorStyles.miniLabel);
        GUILayout.BeginHorizontal();
        ...
        if (GUILayout.Button("X")) {
            ...
            transform.localRotation = Quaternion.Euler(new Vector3(-transform.localRotation.eulerAngles.x, transform.localRotation.eulerAngles.y, transform.localRotation.eulerAngles.z));
        }
        ...
        if (GUILayout.Button("X")) {
            ...
            transform.rotation = Quaternion.Euler(new Vector3(-transform.rotation.eulerAngles.x, 180 - transform.rotation.eulerAngles.y, transform.rotation.eulerAngles.z));
        }
        if (GUILayout.Button("Y")) {
            //undo state
            Undo.RecordObject(transform, "Mirror across Y");
        ...
        EditorGUILayout.LabelField("Modified Transform Script by Happyrobot33", EditorStyles.wordWrappedLabel);
    }
}