...
namespace HappysTools.EditorGames.InspectorCubeRender
{
    public class InspectorCubeRender : EditorWindow
    {
        ...
        [MenuItem("VRC Packages/Happys Tools/Editor Games/Cube Renderer")]
        ...
        public void DrawScreen()
        {
            ...
            for (int y = 0; y < screen.GetLength(1); y++)
            {
                ...
                for (int x = 0; x < screen.GetLength(0); x++)
                {
                    ...
                    GUILayout.Box(
                        CreatePixelTexture(width / screen.GetLength(0), color),
                        GUILayout.Width(width / screen.GetLength(0)),
                        GUILayout.Height(width / screen.GetLength(0))
                    );
                }
