 ...
 * Initially created by MunifiSense
 * Modified and Maintained by HappyRobot33 with permission
 */
...
public class BuildSizeViewer : EditorWindow {
    ...
    [MenuItem("VRC Packages/Happys Tools/VRC Build Size Viewer")]
    ...
    void OnGUI() {
        ...
        EditorGUILayout.LabelField("Originally created by MunifiSense", EditorStyles.label);
        EditorGUILayout.LabelField("Modified and Maintained by HappyRobot33 with permission", EditorStyles.label);
